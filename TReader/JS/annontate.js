(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.attach_annotations = f()}})(function(){var define,module,exports;return (function(){function r(e,n,t){function o(i,f){if(!n[i]){if(!e[i]){var c="function"==typeof require&&require;if(!f&&c)return c(i,!0);if(u)return u(i,!0);var a=new Error("Cannot find module '"+i+"'");throw a.code="MODULE_NOT_FOUND",a}var p=n[i]={exports:{}};e[i][0].call(p.exports,function(r){var n=e[i][1][r];return o(n||r)},p,p.exports,r,e,n,t)}return n[i].exports}for(var u="function"==typeof require&&require,i=0;i<t.length;i++)o(t[i]);return o}return r})()({1:[function(require,module,exports){
...
// Define some regex patterns for matching boundaries.
        ...
        diff_match_patch.prototype.diff_prettyHtml = function(diffs) {
            ...
            for (var x = 0; x < diffs.length; x++) {
                ...
                switch (op) {
                    case DIFF_INSERT:
                        html[x] = '<ins style="background:#ffe1ec;">' + text + '</ins>';
                        break;
                    case DIFF_DELETE:
                        html[x] = '<del style="background:#ffe1ec;">' + text + '</del>';
                        break;
                    case DIFF_EQUAL:
...
// create a node wrapper function
        ...
        function attach_annotation(exact, prefix, payload, data) {
            ...
            var highlight = document.createElement('mark-hypothesis-annotation');
...
//            anns.forEach(el => { el.style.background = 'none'; });
        ...
        function attach_annotations(rows) {
            ...
            for ( var i=0; i < rows.length; i++ ) {
                ...
                var exact = anno['exact'];
                var prefix = anno['prefix'];
                var payload = 'no data';
    ...
    },{"dom-anchor-text-quote":6,"wrap-range-text":21}]},{},[22])(22)
});
